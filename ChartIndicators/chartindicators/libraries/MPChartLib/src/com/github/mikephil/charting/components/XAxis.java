...
public class XAxis extends AxisBase {
    ...
    public interface fixLabelsListeners{
        int fixMin( int min );
        int fixModulus( int modulus );
    }
    public fixLabelsListeners mFixLabelsListeners = null;
    ...
    /**
     * Field-flag that indicates if xAxis will contain Dates. So, if set to true,
     * the labels will be displayed in a different format depending on axis scale factor.
     */
    private boolean axisShowDates;
    ...
    public boolean isAxisShowDates() {
        return axisShowDates;
    }

    public void setAxisShowDates(boolean axisShowDates) {
        this.axisShowDates = axisShowDates;
    }
    ...
    /**
     * Sets the function to calculate the first label index and the interval
     * between labels.
     *
     * @param listeners
     */

    public void setFixLabelsListeners( fixLabelsListeners listeners ) {
        mFixLabelsListeners = listeners;
    }
