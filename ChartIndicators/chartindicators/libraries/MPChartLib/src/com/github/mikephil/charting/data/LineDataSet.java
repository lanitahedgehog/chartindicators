...
public class LineDataSet extends LineRadarDataSet<Entry> {
    ...
    /**
     * If set to -1 this LineDataSet does not take part in drawing filling
     */
    ...
    public void setArearangeId(int isFillmentAvailable) {
        this.arearangeId = isFillmentAvailable;
    }
