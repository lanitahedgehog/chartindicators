...
public abstract class DataRenderer extends Renderer {
    ...
    /**
     * field that is used when drawing Highlights. It gives the outer code an access for
     * enabling/disabling drawing the highlights details. Now it's only used in CandleStickChartRenderer.
     */
    protected boolean drawHighlightDetails;
    ...
    /**
     * Set this to be true if you need to display details about the highlighted point (open, close, high, low values)
     * and Date in a box near the highlight line. Default is false. Works now only with CandleStickChartRenderer
     * @param enable
     */
    public void setDrawHighlightDetails(boolean enable) {
        this.drawHighlightDetails = enable;
    }
