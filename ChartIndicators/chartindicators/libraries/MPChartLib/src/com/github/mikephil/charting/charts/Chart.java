...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends
    ...
    private boolean mHighlightPerLongClickEnable = false;
    ...
    public boolean isHighlightPerLongClickEnable() {
        return mHighlightPerLongClickEnable;
    }

    /**
     * This method gives the ability to draw Highlights when longpress on chart's viewport. If set to true this automatically
     * disables {@link #mHighLightPerTapEnabled} as single tap will be used to remove current highlights
     * @param enabled
     */

    public void setHighlightPerLongClickEnable(boolean enabled) {
        this.mHighlightPerLongClickEnable = enabled;
        this.mHighLightPerTapEnabled = enabled ? false : mHighLightPerTapEnabled;
    }
